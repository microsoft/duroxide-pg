...
- New migration `0004_add_session_support.sql` — sessions table, session routing in fetch/ack
- Fixed `notify_one()` → `notify_waiters()` for correct session-aware worker wake-up
